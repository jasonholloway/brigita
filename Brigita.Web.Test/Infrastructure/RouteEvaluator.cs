...
namespace Brigita.Web.Test.Infrastructure
{
        ...
        public IList<RouteData> GetMatches(string virtualPath, string httpMethod) {
            ...
            foreach(var route in this.routes) {
                ...
                if(!string.IsNullOrEmpty(httpMethod)) {
                    request.Setup(req => req.HttpMethod)
                                .Returns(httpMethod);
                }

                RouteData routeData = this.routes
                                            .GetRouteData(context.Object);
