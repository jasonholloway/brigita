...
namespace Nop.Services.Stores
{
    ...
    public partial class StoreMappingService : IStoreMappingService
    {
        ...
        private readonly IRepository<StoreMapping> _repo;
            ...
            CatalogSettings catalogSettings)
        {
            ...
            this._repo = storeMappingRepository;
        ...
        public virtual StoreMapping GetStoreMappingById(int storeMappingId)
        {
            ...
            return _repo.GetById(storeMappingId);
        }
        ...
        public virtual IList<StoreMapping> GetStoreMappings<T>(T entity) 
            where T : BaseEntity, IStoreMappingSupported
        {
            if (entity == null)
            ...
            var query = from sm in _repo.Table
        ...
        /// <param name="entity">Entity</param>
        public virtual void InsertStoreMapping<T>(T entity, int storeId) 
            where T : BaseEntity, IStoreMappingSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");
        ...
        public virtual int[] GetStoresIdsWithAccess<T>(T entity) 
            where T : BaseEntity, IStoreMappingSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");
        ...
        public virtual bool Authorize<T>(T entity) 
            where T : BaseEntity, IStoreMappingSupported
        {
        ...
        /// <returns>true - authorized; otherwise, false</returns>
        public virtual bool Authorize<T>(T entity, int storeId) 
            where T : BaseEntity, IStoreMappingSupported
        {
            if (entity == null)
                return false;
