...
using Brigita.Web.Extensions;
using Nop.Web.Framework.Localization;
using Nop.Web.Framework.Security;
using Nop.Web.Framework.Security.Captcha;
using Nop.Web.Framework.Themes;
using Brigita.Web.Infrastructure.Cache;
using Brigita.Web.Models.Catalog;
using Brigita.Web.Models.Common;
using Brigita.Web.Models.Topics;

//This needs splitting into smaller controllers!
//the number of fields and ctor args is preposterous
